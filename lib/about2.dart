                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                          image: AssetImage("img/samuraijack.jpeg"),
                        ),
                      ),
                    ),
                    Padding(padding: const EdgeInsets.only(right: 30),
                      child: Column(
                        children: [
                          Text("Samurai Jack",style: TextStyle(fontSize: 16,color: Color(0xFF0d253e)),),
                          Text("Samurai",style: TextStyle(fontSize: 18),)
                        ],
                      ),
                    )
                  ],
                      ...
                      Container(
                        ...
                        child:Column(
                          children: [
                            ...
                            SizedBox(height: 15,),
                            Text("Aku Yokedilecek",style: TextStyle(fontSize: 15,color: Colors.white)),
                            SizedBox(height: 10,),
                            Text("Dünya Kurtarılacak",style: TextStyle(fontSize: 12,color: Colors.white)),
                          ],
                        ),
                      ),
                      Container(
                        ...
                        child:Column(
                          children: [
                            ...
                            SizedBox(height: 15,),
                            Text("Gıda",style: TextStyle(fontSize: 15,color: Colors.white)),
                            SizedBox(height: 10,),
                            Text("Fırın İnşası",style: TextStyle(fontSize: 12,color: Colors.white)),
                          ],
                        ),
                      ),
